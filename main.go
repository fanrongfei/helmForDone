...
import (
	...
	"helmForDone/internal/errorhandler"
	"helmForDone/internal/helm"
	"helmForDone/internal/kube"
)
...
type (
	Config struct {
		...
		Lint      bool `envconfig:"LINT" default:"false"`             // *helm lint option
		...
		BuildDependencies  bool     `envconfig:"BUILD_DEPENDENCIES" default:"false"`   // *helm dependency build option
